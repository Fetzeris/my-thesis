...
Note:       Please make sure to readjust the working directory path in line 16
...
fig2_xrd_multi <- makefigure2(data_fig2, multi = TRUE, var = "xrd_atq", a = 0.008, 
                           ...
                           title1 = "Frequent Violators",
                           legendposition = "none")
fig2_xrd_once <- makefigure2(data_fig2, once =TRUE, var = "xrd_atq", a = 0.015, 
                          breaks_mean = c( 0.025, 0.030, 0.035), 
                          breaks_median = c( 0.01, 0.014,0.018), 
                          ylim =  c(0.024, 0.036), 
                          title1 = "One-time Violators",
                          legendposition = "none")
